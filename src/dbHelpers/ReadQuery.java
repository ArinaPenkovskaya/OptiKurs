    ...
    public String getHTMLtable() {
        ...
        try {
            while (this.results.next()) {
                ...
                client.setClientID(this.results.getInt("ClientID"));
                ...
                table += "<td>";
                String addNUL = Integer.toString(client.getClientID());
                ...
                table += "<td>";
                table += "<input type=\"button\" name=\"button\" value=\"Удалить\" onclick=\"return confirmDelete(" + client.getClientID() + ")\">";
                table += "</td>";

                table += "<td>";
                table += "<a href=update?ClientID=" + client.getClientID() + "> Изменить </a>";
                table += "</td>";
                table += "</tr>";
            }
        } catch (SQLException ex) {
