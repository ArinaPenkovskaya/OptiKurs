    ...
    public String getHTMLtableOD() throws ParseException {
        ...
        try {
            ...
            while (this.results.next()) {
                ...
                od.setDepName(this.results.getString("depositName"));
                ...
                od.setDateOfStartS(this.results.getString("dateOfStart"));
                od.setDateOfFinishS(this.results.getString("dateOfFinish"));
