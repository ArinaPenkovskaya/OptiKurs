...
CREATE TABLE `deposits` (
  ...
  `pBYN` double NOT NULL,
  `pEUR` double NOT NULL,
  `pRUB` double NOT NULL,
  `pUSD` double NOT NULL,
  PRIMARY KEY (`depositID`),
  UNIQUE KEY `depositName_UNIQUE` (`depositName`),
...
INSERT INTO `deposits` VALUES (1,'Срочный вклад (№1)',1,999,9.2,1,8,1.5);
